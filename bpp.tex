...
This function returns new Automaton object specified by regular expression passed in as an argument. The regular expression has to be in format specified in chapter: TODO.
...
\begin{thebibliography}{1}
	...
	\bibitem{moore-mealy} Melichar%TODO PUBLIKACE 	
	
	\bibitem{dfa-wiki} Wikipedia page of Deterministic Finite Automata \url{https://en.wikipedia.org/wiki/Deterministic_finite_automaton}
